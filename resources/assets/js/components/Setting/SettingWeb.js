    ...
    if (this.state.loading) {
      ...
      return (
        <Form onSubmit={this.handleSubmit} style={{ paddingTop: 20 }}>
          <FormItem {...formItemLayout} label="网站名称" extra={<Alert message="网站名称" type="warning" showIcon />}>
          ...
          <FormItem {...formItemLayout} label="图片存储位置" extra={<Alert message="网站图片的存储位置" type="warning" showIcon />}>
                ...
                <Popover
                  content={(
                    <div>
                      ...
                      <Badge status="warning" text="本地系统盘空间较小，以后会改进！" />
                    </div>
                  )}>
          ...
          <FormItem {...formItemLayout} label="网站备案号" extra={<Alert message="网站备案信息，可以不填" type="info" showIcon />}>
